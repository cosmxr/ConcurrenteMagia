...
//Aspecto personalizado para el log de la creación de hechizos de tipo 'UTILITY'
@Aspect
@Component
public class UtilitySpellAspect {
    ...
    public void logUtilitySpell(Spell spell, Object result) {
        if (spell.getType() == SpellType.UTILITY) {
            System.out.println("A spell of type 'UTILITY' was saved: " + spell.getName());
        }
    }
}